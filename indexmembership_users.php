...
{
 $sql_query="DELETE FROM membership_users WHERE id=".$_GET['delete_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
if(isset($_GET['changestatus_id']))
{
 $sql_query="UPDATE membership_users SET `status`='".$_GET['status']."' WHERE id=".$_GET['changestatus_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
?>
...
function edt_id(id)
{
  window.location.href='edit_membership_users.php?edit_id='+id;
}
function view_id(id)
{
  window.location.href='view_membership_users.php?view_id='+id;
}
...
<div id="body">
 <div id="content">
    ...
    <tr>
    <th colspan="5"><a href="add_membership_users.php">add membership_users.</a></th>
    </tr>
    <th>SL NO</th>
    <th>id</th>
    ...
    <?php
 $sql_query="SELECT * FROM membership_users";
